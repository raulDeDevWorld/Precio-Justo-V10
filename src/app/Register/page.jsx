...
function Home() {
    ...
    const registerHandler = (e) => {
        ...
        writeUserData('Users', { uuid: user.user.id, nombre, rol, ciudad })
    }


    // useEffect(() => {
    //     // if (user) readUserData('Users', user.user.id, userDB, setUserData)
    //     // if (user && user.rol ) router.replace(user.rol)
    //   }, [userDB]);
