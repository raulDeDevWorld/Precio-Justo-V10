        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between bg-[#1D0F4A] mx-auto p-4 z-[1000]">
          <a class="flex items-center">
            ...
            <div class="relative">
              ...
              <input type="text" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-gray-200 border-b border-gray-300  bg-transparent focus:ring-white focus:border-white focus:outline-transparent" placeholder="Busca tu producto..." />
            </div>
